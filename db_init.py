...
cur.execute("CREATE TABLE article(article_id INTEGER PRIMARY KEY AUTOINCREMENT,\
                title VARCHAR(512),\
                author VARCHAR(100),\
...
cur.execute("CREATE TABLE announcement(announcement_id INTEGER PRIMARY KEY AUTOINCREMENT,\
                title VARCHAR(512),\
                author VARCHAR(100),\
                content VARCHAR(1000000),\
                date_ VARCHAR(100),\
...
cur.execute("CREATE TABLE user_info (user_id INTEGER,\
                username VARCHAR(32),\
                e_mail VARCHAR(128),\
